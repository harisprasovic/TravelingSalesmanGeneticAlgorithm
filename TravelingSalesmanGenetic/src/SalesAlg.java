...
public class SalesAlg {
	...
	public SalesAlg(int numberOfCities, SelectionType selectionType, int[][] travelPrices, int startingCity, int targetFitness){
    ...
    public List<SalesmanGenome> crossover(List<SalesmanGenome> parents){
        Random random = new Random();
        int a = random.nextInt(genomeSize);
